...
public:
    ...
    bool sendScroll(WId window) override
    {
        ...
        // Note: Cursor should already be positioned at target center before
        // first frame capture (by AutoScroller::moveCursorToTarget).
        // We don't move it here to avoid changing hover states between frames.
