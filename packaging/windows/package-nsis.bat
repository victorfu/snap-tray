...
REM SnapTray Windows NSIS Packaging Script
REM Creates an NSIS installer
REM
REM Usage:
REM   package-nsis.bat
REM
REM Prerequisites:
...
echo !define VERSION "%VERSION%" > "%SCRIPT_DIR%version.nsh"
echo !define APP_NAME "%APP_NAME%" >> "%SCRIPT_DIR%version.nsh"
echo !define STAGING_DIR "%STAGING_DIR%" >> "%SCRIPT_DIR%version.nsh"
echo !define OUTPUT_DIR "%OUTPUT_DIR%" >> "%SCRIPT_DIR%version.nsh"
echo !define PROJECT_ROOT "%PROJECT_ROOT%" >> "%SCRIPT_DIR%version.nsh"
endlocal
...
echo.
echo To install: Run the Setup.exe and follow the wizard
