...
- [從原始碼建置](/zh-tw/developer/build-from-source/)：前置需求、腳本、手動 CMake 流程、快取工具與本地建置排錯
- [發佈與打包](/zh-tw/developer/release-packaging/)：DMG / NSIS / MSIX 打包、簽章、公證、Store 提交流程與圖示資產
- [架構總覽](/zh-tw/developer/architecture/)：專案結構、library 邊界、架構模式、平台對照與開發慣例
- [MCP（僅 Debug Build）](/zh-tw/developer/mcp-debug/)：內建 localhost MCP server、tool contract 與整合方式
...
1. [從原始碼建置](/zh-tw/developer/build-from-source/)
2. [架構總覽](/zh-tw/developer/architecture/)
3. [發佈與打包](/zh-tw/developer/release-packaging/)
4. 需要 debug 自動化時再看 [MCP（僅 Debug Build）](/zh-tw/developer/mcp-debug/)
